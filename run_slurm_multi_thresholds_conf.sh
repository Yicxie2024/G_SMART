...
for OPTION in $(seq $START_OPTION $END_OPTION); do
  ...
  case "$OPTION" in
    0) CONFIG=recipes/Qwen2.5-7B-Instruct/beam_search_smart.yaml; EXTRA=(--n=1 --beam_width=16 --score_method=conf --uq_threshold=0.20 --dataset_start=51 --dataset_end=500) ;;
    1) CONFIG=recipes/Qwen2.5-7B-Instruct/beam_search_smart.yaml; EXTRA=(--n=1 --beam_width=16 --score_method=conf --uq_threshold=0.40 --dataset_start=51 --dataset_end=500) ;;
    2) CONFIG=recipes/Qwen2.5-7B-Instruct/beam_search_smart.yaml; EXTRA=(--n=1 --beam_width=16 --score_method=conf --uq_threshold=0.60 --dataset_start=51 --dataset_end=500) ;;
    3) CONFIG=recipes/Qwen2.5-7B-Instruct/beam_search_smart.yaml; EXTRA=(--n=1 --beam_width=16 --score_method=conf --uq_threshold=0.70 --dataset_start=51 --dataset_end=500) ;;
    4) CONFIG=recipes/Qwen2.5-7B-Instruct/beam_search_smart.yaml; EXTRA=(--n=1 --beam_width=16 --score_method=conf --uq_threshold=0.80 --dataset_start=51 --dataset_end=500) ;;
    5) CONFIG=recipes/Qwen2.5-7B-Instruct/beam_search_smart.yaml; EXTRA=(--n=1 --beam_width=16 --score_method=conf --uq_threshold=0.85 --dataset_start=51 --dataset_end=500) ;;
    6) CONFIG=recipes/Qwen2.5-7B-Instruct/beam_search_smart.yaml; EXTRA=(--n=1 --beam_width=16 --score_method=conf --uq_threshold=0.90 --dataset_start=51 --dataset_end=500) ;;
    7) CONFIG=recipes/Qwen2.5-7B-Instruct/beam_search_smart.yaml; EXTRA=(--n=1 --beam_width=16 --score_method=conf --uq_threshold=0.95 --dataset_start=51 --dataset_end=500) ;;
